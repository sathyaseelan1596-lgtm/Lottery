...
export const CONTRACT_ADDRESS = "0x3579F31A6FF3d19ECa5805CF19838d9936285be1";
export const ABI = [
  {
    inputs: [
...
export const RNG_ADDRESS = "0xbd8e4005910429aae1a40fc211f2ff03a65024ae";
export const RNG_ABI = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_pancakeSwapLottery", type: "address" },
    ],
...
export const VRF_MOCK_ADDRESS = "0x623ce812524905d56d79F584064cC1aD6810E3A6";
